...
# * https://gist.github.com/eric-s-s/11e08dbc38891fa3d0eba5396703afc6
#
...
#
# - See if function/file can be added to message
# - Use logging feature to write to stderr instead of print()
# - Get testing working
# - Get module working
#
